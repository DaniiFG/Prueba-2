...
# JWT Settings
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=2),  # Aumentar a 2 horas
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'your-email@gmail.com'  # Cambiar por email real
EMAIL_HOST_PASSWORD = 'your-password'  # Cambiar por contraseña o app password
DEFAULT_FROM_EMAIL = 'your-email@gmail.com'  # Cambiar por email real
